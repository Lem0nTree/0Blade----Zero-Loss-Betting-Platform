export const messages = {
  please_connect: 'Please connect your wallet to the Cronos network to use CronoSports.',
  ...
  exiting_warmup: 'By exiting the warmup period before end of 3 rebases, you will lose your warmup rewards.',
  ...
  switch_to_tatara: 'Switch to the TATARA network?',
  ...
  minimum_bet: (value: string, token: string) => `Minimum bet amount should be more than  ${value} ${token}.`,
};
